  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <div class="container-fluid">
            <a class="navbar-brand text-white" href="index.php">Laundry FAANG</a>
          ...
          $query = mysqli_query($conn, "SELECT * FROM data_tahun  limit $start, $hal");
               ...
               if(mysqli_num_rows($query) <= 0){
                 ...
                 echo "</div>";
                  ...
                  <td><center><a href="delete_tahun.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-warning mt-2 mb-2">  Hapus</button></a></td>
                  <td><center><a href="detail_tahun.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-primary mt-2 mb-2">Detail</button></a>
                   </tr>
        <?php
      }}
          ?>
